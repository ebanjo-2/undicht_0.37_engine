...
namespace undicht {
    ...
    void ColladaFile::loadVertexData(std::vector<std::vector<float>>& vertices, std::vector<core::BufferLayout>& vertex_layouts) {
        ...
        for(XmlElement* e : geometries) {
            ...
            vertex_layouts.emplace_back(core::BufferLayout());

            loadGeometry(*e, vertices.back(), vertex_layouts.back());
        ...
        void ColladaFile::loadGeometry(XmlElement& geometry, std::vector<float>& vertices, core::BufferLayout& vertex_layout) {
        ...
        void ColladaFile::loadGeometry(XmlElement& geometry, Model3D& loadTo) {
            ...
            core::BufferLayout vertex_layout;

            loadGeometry(geometry, vertices, vertex_layout);
